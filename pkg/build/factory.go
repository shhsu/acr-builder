...
type factory struct {
	name       string
	isSelected bool
	create     func() (domain.BuildSource, error)
}
...
func newFactory(name string, create func() (domain.BuildSource, error), required []parameter, optional []parameter) (*factory, error) {

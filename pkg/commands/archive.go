...
func NewArchiveSource(url string, targetDir string) domain.BuildSource {
	return &ArchiveSource{url: url, targetDir: targetDir}
}

// Obtain downloads and extract the source
func (s *ArchiveSource) Obtain(runner domain.Runner) error {
...
func (s *ArchiveSource) Return(runner domain.Runner) error {
	if s.tracker != nil {
...
func (s *ArchiveSource) Export() []domain.EnvVar {
